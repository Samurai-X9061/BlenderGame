...
class ThirdPersonCamera(bge.types.KX_PythonComponent):
    """ Third Person Camera Component:
        Add a camera in your scene, parent them into your character capsule, 
    ...
    def start(self, args):
        ...
        self.setCameraPos(args["Camera Crab (Side)"], -args["Camera Distance"], args["Camera Height"])
...
####-<PRIVATE FUNCTIONS>-######################################################
    ...
    def __applyCameraPosition(self):
        ...
        if self.cameraCol:
            ...
            obHit, obPos, _ = self.object.rayCast(target, camPos, 0, self.cameraColProp, 1, 0, 0)
            if obHit != None:
                camPos = obPos
